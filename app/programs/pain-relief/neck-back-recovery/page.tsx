...
export default function NeckBackRecoveryPage() {
  ...
  const courseSyllabus = [
    {
      ...
      title: "久坐為什麼容易肩頸腰痛？",
      details:
        "解析長時間久坐、低活動量與工作壓力如何影響肩頸、下背與身體循環，理解痠痛背後真正的原因。",
    },
    {
      num: "02",
      title: "上班族常見的姿勢與代償問題",
      details:
        "從圓肩、駝背、骨盆失衡到核心無力，理解身體如何因長期姿勢不良逐漸累積壓力與不適。",
    },
    {
      num: "03",
      title: "改善肩頸與下背壓力的修復方式",
      details:
        "透過呼吸、活動與簡單放鬆技巧，改善久坐造成的身體緊繃與疲勞問題。",
    },
    {
      num: "04",
      title: "建立不容易痠痛的日常習慣",
      details:
        "協助員工建立可長期執行的身體使用與恢復方式，降低反覆痠痛與身體負擔。",
    },
  ];
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            長時間久坐與高壓工作，往往讓肩頸僵硬、下背緊繃與疲勞感逐漸累積。
            <br />
            本課程協助上班族建立更有效的身體恢復與修復方式。
          </p>
          ...
          >
            協助員工理解肩頸與下背痠痛的來源，建立日常可執行的修復與放鬆策略，降低長期久坐造成的身體負擔。
          </p>
        </div>
      </section>
      ...
      <section
        style={{
          background: "#ece7df", // 高級沉穩沙色底，做為視覺節奏轉換
          padding: "100px 24px",
        }}
      >
        <div
      ...
      >
        ...
        >
          適合企業健康講座、職場常見痠痛管理與同仁 wellness 教育，
          <br />
          協助團隊理解身體慢性勞損背後的姿勢代償，引入科學修復，重拾舒適高效的辦公日常。
        </p>
