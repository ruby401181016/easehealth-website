...
export default function MovementRestorationPage() {
  ...
  const courseSyllabus = [
    {
      ...
      title: "為什麼身體會越來越卡？",
      details:
        "解析長時間久坐、缺乏活動與固定姿勢如何讓關節活動度下降，造成身體僵硬、動作卡卡與活動受限。",
    },
    {
      num: "02",
      title: "上班族常見的活動受限問題",
      details:
        "認識肩膀打不開、髖部僵硬、胸椎活動不足與下肢緊繃等常見狀況，理解身體功能下降的原因。",
    },
    {
      num: "03",
      title: "重建活動能力的日常策略",
      details:
        "透過簡單活動、關節控制與動作練習，幫助身體重新找回更自然、穩定的活動方式。",
    },
    {
      num: "04",
      title: "讓身體重新變得好用",
      details:
        "協助員工建立日常可執行的活動與修復習慣，降低身體僵硬與功能下降造成的不適。",
    },
  ];
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            身體越來越卡，往往不是老化，而是長時間固定姿勢與活動不足累積的結果。
            <br />
            本課程協助上班族重新建立自然、穩定的活動能力。
          </p>
          ...
          >
            協助員工改善身體僵硬、活動受限與動作不順問題，重新建立更自然、更穩定的身體活動能力。
          </p>
        </div>
      </section>
      ...
      >
        ...
        >
          ...
          <br />
          協助團隊打破日復一日的關節退化僵局，重拾靈活柔韌的身體掌控力，釋放職場原有工作效率。
        </p>
