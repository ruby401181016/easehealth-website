...
export default function MetabolicFatiguePage() {
  ...
  const courseSyllabus = [
    {
      ...
      title: "認識代謝症候群的關鍵指標",
      details:
        "理解腰圍、血壓、血糖、血脂與三酸甘油脂等指標，了解它們如何共同反映身體代謝狀態。",
    },
    {
      num: "02",
      title: "為什麼上班族容易慢性疲勞？",
      details:
        "從久坐、壓力、睡眠不足與飲食不規律切入，解析長期疲勞不只是累，而可能是身體失衡的訊號。",
    },
    {
      num: "03",
      title: "脂肪肝、腰圍與內臟脂肪警訊",
      details:
        "說明脂肪肝、腹部肥胖與內臟脂肪累積，如何提高慢性病、心血管疾病與長期疲勞風險。",
    },
    {
      num: "04",
      title: "建立可執行的代謝改善策略",
      details:
        "從日常活動量、飲食選擇、睡眠恢復與壓力管理開始，建立企業員工能長期維持的健康行動方案。",
    },
  ];
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            長期疲勞、腰圍增加、脂肪肝與血糖血脂異常，可能不是單一問題，而是身體代謝正在失衡。
            <br />
            本課程協助員工理解高壓久坐生活如何影響身體狀態，並建立可執行的改善策略。
          </p>
          ...
          >
            協助員工辨識代謝症候群與慢性疲勞的早期訊號，從生活型態中找到可執行、可持續的健康改善方向。
          </p>
        </div>
      </section>
      ...
      <section
        style={{
          background: "#ece7df", // 高級沉穩沙色底，做為視覺切換
          padding: "100px 24px",
        }}
      >
        <div
      ...
      >
        ...
        >
          適合企業健康月、健檢後健康講座與員工 wellness 教育，
          <br />
          協助員工理解疲勞與代謝失衡背後的健康訊號，從根本提升團隊續航力。
        </p>
