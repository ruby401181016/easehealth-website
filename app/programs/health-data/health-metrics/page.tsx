...
export default function HealthMetricsPage() {
  ...
  const courseSyllabus = [
    {
      num: "01",
      title: "解密關鍵紅字：三高指標的潛在風險",
      details:
        "解讀血壓、總膽固醇、中性脂肪與空腹血糖。了解數據背後的生理意義，拒絕盲目焦慮，並學會區分急迫性風險與慢性調整指標。",
    },
    {
      num: "02",
      title: "常見健檢數據怎麼看？",
      details:
        "說明肝功能、腎功能、尿酸、血脂與血糖等常見健檢項目，幫助員工建立基礎健康判讀能力。",
    },
    {
      num: "03",
      title: "正常數值不代表完全健康",
      details:
        "理解數據趨勢、生活型態與身體感受之間的關係，避免只用單次紅字或正常值判斷健康狀態。",
    },
    {
      num: "04",
      title: "把健檢報告轉化為健康行動",
      details:
        "協助員工根據自身健檢狀況，建立飲食、活動量、睡眠與追蹤習慣，讓報告成為改善健康的起點。",
    },
  ];
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            健檢報告不只是紅字提醒，更是了解身體狀態的重要線索。
            <br />
            本課程協助員工看懂常見健檢數據，降低不必要的焦慮，建立正確健康判讀能力。
          </p>
          ...
          >
            協助員工理解健檢報告中的關鍵數字，從「看見紅字」進一步轉化為可執行的健康改善方向。
          </p>
        </div>
      </section>
      ...
      >
        ...
        >
          適合企業健檢後講座、健康月活動與員工健康識能教育，
          <br />
          協助團隊建立更清楚的健康判讀能力，從源頭落實職場健康照護。
        </p>
