...
export default function SedentaryHealthPage() {
  ...
  const courseSyllabus = [
    {
      ...
      title: "久坐如何影響身體健康",
      details:
        "理解長時間坐姿如何影響血液循環、肩頸腰背、核心穩定與整體活動量，建立對久坐風險的基礎認識。",
    },
    {
      num: "02",
      title: "辦公室常見痠痛與身體失衡",
      details:
        "解析肩頸緊繃、下背不適、髖關節僵硬與圓肩駝背等常見問題，了解疼痛背後的姿勢與動作原因。",
    },
    {
      num: "03",
      title: "日常可執行的微運動策略",
      details:
        "設計適合辦公室情境的伸展、活動與簡易肌力動作，讓員工在工作日中也能累積有效活動量。",
    },
    {
      num: "04",
      title: "建立可持續的久坐修復習慣",
      details:
        "協助員工建立工作間歇、動作提醒、簡短伸展與恢復流程，將身體照顧自然融入日常工作節奏。",
    },
  ];
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            長時間久坐不只會造成肩頸腰背不適，也可能影響循環、活動量與身體恢復。
            <br />
            本課程協助員工理解久坐對身體的影響，並建立日常可執行的修復與活動策略。
          </p>
          ...
          >
            協助員工從久坐造成的不適與身體失衡中，建立簡單、可持續、能融入工作日常的健康管理方式。
          </p>
        </div>
      </section>
      ...
      >
        ...
        >
          適合企業健康講座、辦公室伸展活動與員工 wellness 教育，
          <br />
          協助員工降低久坐造成的身體負擔，重拾輕盈與專注的辦公狀態。
        </p>
