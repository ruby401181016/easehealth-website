...
export default function HealthDataPage() {
  ...
  const topicsData = [
    {
      id: "01",
      title: "上班族必懂健檢數據",
      enTitle: "UNDERSTANDING HEALTH METRICS",
      desc: "從常見健檢數據出發，協助員工理解紅字背後的健康意義，建立正確健康判讀能力。",
      image: "/健檢.png",
      href: "/programs/health-data/health-metrics",
    },
    {
      id: "02",
      title: "代謝症候群與慢性疲勞",
      enTitle: "METABOLIC SYNDROME & FATIGUE",
      desc: "解析高壓久坐生活如何影響代謝、疲勞與慢性病風險，建立可執行的健康改善策略。",
      image: "/代謝.png",
      href: "/programs/health-data/metabolic-fatigue",
    },
    {
      id: "03",
      title: "內分泌失衡與體態變化",
      enTitle: "HORMONAL BALANCE & BODY CHANGES",
      desc: "從壓力、睡眠與荷爾蒙變化切入，理解體態改變背後真正的身體訊號。",
      image: "/內分泌失衡2.png",
      href: "/programs/health-data/hormonal-balance",
    },
    {
      id: "04",
      title: "久坐族健康管理",
      enTitle: "SEDENTARY LIFESTYLE MANAGEMENT",
      desc: "針對久坐造成的肩頸痠痛、循環下降與活動不足，建立日常可持續的修復策略。",
      image: "/久坐2.png",
      href: "/programs/health-data/sedentary-health",
    },
  ];
  ...
  return (
    ...
    >
      ...
      <section
        style={{
          padding: "80px 24px 70px", // 🚀 已修正：收緊上下留白，完美解決空洞感
          textAlign: "center",
      ...
      <section
        style={{
          maxWidth: "1180px",
          margin: "0 auto",
          padding: "70px 24px 120px", // 🚀 已修正：完美縮緊頂部，流暢銜接 Hero
        }}
      >
        {/* Section Header */}
