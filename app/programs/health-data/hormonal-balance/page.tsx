  ...
  const courseSyllabus = [
    {
      ...
      title: "壓力荷爾蒙如何影響體態",
      details:
        "解析長期壓力、睡眠不足與皮質醇變化，如何影響食慾、脂肪累積、恢復能力與精神狀態。",
    },
    {
      num: "02",
      title: "為什麼越忙越容易胖？",
      details:
        "從外食、久坐、壓力性進食與作息不穩定切入，理解體態變化背後不只是熱量問題。",
    },
    {
      num: "03",
      title: "內分泌失衡與能量下降",
      details:
        "說明胰島素、壓力荷爾蒙、睡眠與活動量如何共同影響身體能量、疲勞感與代謝效率。",
    },
    {
      num: "04",
      title: "建立穩定體態的生活策略",
      details:
        "透過飲食節奏、睡眠恢復、壓力管理與日常活動安排，建立更可持續的體態管理方式。",
    },
  ];
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            體態變化不只是吃太多或動太少，長期壓力、睡眠不足與荷爾蒙變化，都可能影響食慾、脂肪累積與身體恢復。
            <br />
            本課程協助員工理解身體失衡的原因，並建立更穩定、可持續的健康生活策略。
          </p>
          ...
          >
            協助員工理解壓力、睡眠、飲食與荷爾蒙如何影響體態，從「瘦不下來」進一步找到可執行的生活調整方向。
          </p>
        </div>
      </section>
      ...
      >
        ...
        >
          ...
          <br />
          協助團隊理解體態變化背後的壓力與生活型態因素，打造健康的職場活力。
        </p>
