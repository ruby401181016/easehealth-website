  ...
  const courseSyllabus = [
    {
      ...
      title: "為什麼環境會影響健康行為？",
      details:
        "理解環境提示、行為慣性與日常動線，如何在不知不覺中影響飲食、活動量與生活選擇。",
    },
    {
      num: "02",
      title: "哪些生活環境正在默默影響你？",
      details:
        "從辦公桌、家中空間、手機使用、通勤動線與社交環境切入，找出最容易干擾健康行動的因素。",
    },
    {
      num: "03",
      title: "如何降低不健康行為的誘惑？",
      details:
        "透過預先設計、減少阻力與調整環境提示，降低零食、久坐、拖延與熬夜等行為發生的機率。",
    },
    {
      num: "04",
      title: "打造更容易執行健康行動的生活空間",
      details:
        "協助員工重新設計辦公與居家環境，讓健康選擇變得更順手、更自然、更容易持續。",
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            <br />
            而是受到環境、動線與日常提示影響。
            本課程協助員工重新設計生活空間，讓健康選擇變得更自然、更容易持續。
          </p>
          ...
          >
            協助員工理解環境如何影響健康行為，並學會透過空間、動線與提示設計，降低阻力、提高健康行動的成功率。
          </p>
        </div>
      </section>
      ...
      >
        ...
        >
          適合企業健康講座、習慣養成與生活空間設計主題，
          <br />
          協助員工打造不費力、自然而然就能維持健康的微調型空間。
        </p>
