...
export default function ThreeMinuteMovementPage() {
  ...
  const courseSyllabus = [
    {
      ...
      title: "為什麼開始運動總是很難？",
      details:
        "解析上班族常見的拖延、完美主義與高門檻問題，理解為什麼健康行動總是難以開始。",
    },
    {
      num: "02",
      title: "建立低阻力的運動習慣",
      details:
        "透過三分鐘法則與微習慣設計，降低開始成本，讓運動變得更容易執行。",
    },
    {
      num: "03",
      title: "如何把運動融入日常生活？",
      details:
        "從通勤、午休、工作空檔到下班後，建立更適合上班族的生活化活動方式。",
    },
    {
      num: "04",
      title: "先開始，比做很多更重要",
      details:
        "建立成功感與穩定節奏，避免因過高期待而放棄，讓健康真正融入生活。",
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            運動不一定需要大量時間與高強度計畫。
            <br />
            本課程協助上班族從小行動開始，建立更容易執行、能長期維持的健康習慣。
          </p>
          ...
          >
            協助員工降低開始運動的心理壓力，透過更簡單、更生活化的方式，讓健康行動真正融入日常生活。
          </p>
        </div>
      </section>
      ...
      >
        ...
        >
          拋開必須上健身房的一小時執念，專為高壓久坐同仁設計的微習慣健康講座。
          <br />
          協助團隊打破完美主義的拖延惰性，用不耗費意志力的「極低門檻小行動」開啟職場新氣象。
        </p>

        {/* 🚀 全站一致：直達獨立客製化合作表單洽詢頁面 */}
        <a
          href="/contact"
          style={{
