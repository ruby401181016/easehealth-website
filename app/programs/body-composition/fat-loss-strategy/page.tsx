...
export default function FatLossStrategyPage() {
  const [activeModule, setActiveModule] = useState(0);

  // 💡 同步 EASE 風格 A 的質感雙字體系統
  ...
  const courseSyllabus = [
    {
      num: "01",
      title: "外食族為什麼容易胖？破解熱量陷阱",
      details:
        "分析上班族常見的外食型態、飲料習慣與隱藏熱量來源，理解為什麼看似吃不多卻仍容易累積脂肪。",
    },
    {
      num: "02",
      title: "便利商店、便當與聚餐的飲食選擇策略",
      details:
        "建立可實際執行的外食選擇原則，學會如何在便利商店、自助餐、餐廳與聚餐情境中降低負擔。",
    },
    {
      num: "03",
      title: "燃燒脂肪的關鍵：穩定代謝與飲食節奏",
      details:
        "理解蛋白質、進食頻率與熱量分配的重要性，避免過度節食與暴食循環造成的代謝下降。",
    },
  ];

  // 全站一致的極簡霧灰白 Footer 聯絡文字樣式
      ...
      >
        ...
        >
          ...
          >
            外食不代表一定會胖。
            <br />
            本課程將協助員工理解日常飲食中的熱量陷阱，
            並建立在忙碌工作生活中也能長期執行的飲食管理策略。
          </p>
