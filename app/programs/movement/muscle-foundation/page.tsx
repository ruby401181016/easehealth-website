...
export default function MuscleFoundationPage() {
  ...
  const courseSyllabus = [
    {
      ...
      title: "為什麼上班族需要增肌？",
      details:
        "理解肌肉量與基礎代謝、體態、疲勞感及日常活動能力的關係，建立增肌不只是變壯，而是提升身體功能的觀念。",
    },
    {
      num: "02",
      title: "力量訓練的基礎概念",
      details:
        "認識阻力訓練、漸進負荷、訓練頻率與恢復的重要性，幫助零基礎員工建立正確訓練方向。",
    },
    {
      num: "03",
      title: "上班族最需要訓練的身體能力",
      details:
        "從核心穩定、臀腿力量、背部支撐與姿勢控制切入，了解哪些肌群能幫助改善久坐造成的身體負擔。",
    },
    {
      num: "04",
      title: "建立可持續的增肌入門策略",
      details:
        "協助員工理解飲食、訓練與恢復如何搭配，建立不極端、可融入生活的力量與代謝基礎。",
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            增肌不是只有想變壯的人才需要。
            <br />
            對長時間久坐、活動量不足的上班族來說，肌肉量與力量是維持代謝、體態與日常精神的重要基礎。
          </p>
          ...
          >
            ...
            >
              ...
              >
                ...
                />
                <path
                  d="M12 12C12 8 15 5 19 5+C19 9 16 12 12 12Z"
                  stroke="#8a847c"
                  strokeWidth="1.5"
          ...
          >
            協助員工理解肌力與代謝的關係，建立適合零基礎上班族的增肌入門觀念與訓練方向。
          </p>
        </div>
      </section>
      ...
      >
        ...
        >
          適合企業健康講座、體態活力改善方案與同仁力量教育，
          <br />
          協助團隊破除盲目的增肌迷思，透過科學且安全、可融入日常生活的入門引導，為職場注入全新續航力。
        </p>
