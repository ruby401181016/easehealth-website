...
export default function MovementQualityPage() {
  ...
  const courseSyllabus = [
    {
      ...
      title: "為什麼練很多卻沒有明顯效果？",
      details:
        "解析常見上班族訓練沒成效的原因，理解動作品質、訓練刺激與恢復之間的真正關聯。",
    },
    {
      num: "02",
      title: "建立正確的身體控制能力",
      details:
        "從呼吸、核心穩定與基礎動作開始，提升身體控制能力，降低代償與錯誤發力風險。",
    },
    {
      num: "03",
      title: "提升訓練效率的關鍵原則",
      details:
        "學習如何透過動作順序、訓練品質與基礎架構安排，用更少時間獲得更好的訓練效果。",
    },
    {
      num: "04",
      title: "避免受傷與過度疲勞",
      details:
        "建立長期可持續的運動觀念，避免盲目追求強度與訓練量，降低身體負擔與運動傷害風險。",
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            訓練不是做越多越好。
            <br />
            本課程從動作品質、身體控制與訓練效率出發，協助員工建立更安全、更有效率的運動方式。
          </p>
          ...
          >
            協助員工建立正確動作觀念與身體控制能力，提升訓練效率，降低運動傷害與無效訓練風險。
          </p>
        </div>
      </section>
      ...
      <section
        style={{
          background: "#ece7df", // 高級沉穩沙色底，做為視覺步調轉換
          padding: "100px 24px",
        }}
      >
        <div
      ...
      >
        ...
        >
          適合企業健康講座、體能優化主題與同仁 wellness 品質教育，
          <br />
          協助團隊跳脫盲目追求重量的勞損誤區，用精準與科學的管理，開啟精準高效的健康行動。
        </p>
