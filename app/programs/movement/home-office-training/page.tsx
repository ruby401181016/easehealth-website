...
export default function HomeOfficeTrainingPage() {
  ...
  const courseSyllabus = [
    {
      ...
      title: "沒有健身房也能建立肌力",
      details:
        "打破一定要去健身房才能訓練的迷思，理解徒手訓練、彈力帶與簡單器材也能有效建立肌力與代謝。",
    },
    {
      num: "02",
      title: "上班族最適合的居家訓練方式",
      details:
        "針對久坐、活動量不足與時間有限的族群，建立最容易開始、最能長期執行的訓練架構。",
    },
    {
      num: "03",
      title: "辦公室也能做的日常肌力啟動",
      details:
        "透過簡單動作改善肩頸僵硬、核心無力與下半身循環下降，提升工作中的身體穩定性。",
    },
    {
      num: "04",
      title: "建立可持續的運動習慣",
      details:
        "協助員工建立不依賴意志力與高強度訓練的運動模式，讓運動真正融入生活節奏。",
    },
  ];
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            沒有時間去健身房，不代表不能建立好的身體狀態。
            <br />
            本課程協助上班族利用居家與辦公環境，建立簡單、有效且能長期執行的肌力訓練方式。
          </p>
          ...
          >
            協助員工建立居家與辦公室可執行的肌力訓練方式，降低運動門檻，建立真正能長期維持的運動習慣。
          </p>
        </div>
      </section>
      ...
      >
        ...
        >
          拋開必須使用專業器材的時空限制，專為在宅辦公（WFH）或久坐同仁規劃的微阻力運動方案。
          <br />
          協助團隊靈活運用現有環境與零碎空檔，建立兼顧日常續航力與代謝健康的永續運動生活。
        </p>
