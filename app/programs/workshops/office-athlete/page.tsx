...
export default function OfficeAthletePage() {
  ...
  const courseSyllabus = [
    {
      ...
      title: "上班族也需要身體能力",
      details:
        "從久坐、疲勞與低活動量切入，理解現代工作型態如何影響身體功能與日常表現。",
    },
    {
      num: "02",
      title: "基礎功能性動作挑戰",
      details:
        "透過 squat、carry、core、balance 與反應訓練，建立上班族需要的基本 movement 能力。",
    },
    {
      num: "03",
      title: "Team Mission 團隊任務",
      details:
        "透過小組輪站與累積任務，結合合作、互動與 movement challenge，提升參與感與團隊氛圍。",
    },
    {
      num: "04",
      title: "建立更有活力的工作狀態",
      details:
        "協助員工重新感受 movement 帶來的身體活力與專注力，建立更健康的工作節奏。",
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ flex: "1 1 440px", display: "flex", flexDirection: "column" }}>
          ...
          <p style={{ fontSize: "14.5px", lineHeight: "2.1", color: "#5a5550", fontWeight: 300, marginBottom: "36px" }}>
            結合功能性 movement、團隊合作與互動挑戰，打造上班族也能參與的企業 wellness 體驗，讓員工重新感受身體活動帶來的活力與參與感。
          </p>
          ...
          <p style={{ fontSize: "14px", lineHeight: "2.0", color: "#666", fontWeight: 300 }}>
            協助員工透過 movement challenge 與團隊任務，提升身體活動量、互動參與感與工作活力，建立更健康的 workplace wellness culture。
          </p>
        </div>
      </section>
      ...
      <section style={{ maxWidth: "1180px", margin: "0 auto", padding: "110px 24px 120px", textAlign: "center" }}>
        <h3 style={{ fontFamily: serifFont, fontSize: "32px", fontWeight: 400, marginBottom: "20px", letterSpacing: "0.03em" }}>為您的團隊引入 Office Athlete</h3>
        <p style={{ fontSize: "14.5px", color: "#666", lineHeight: "2.0", fontWeight: 300, maxWidth: "560px", margin: "0 auto 48px auto" }}>
          打破職場沈悶節奏，透過高度互動的 movement 團隊競賽與挑戰，將運動轉化為最有效的團建體驗，重啟員工動能。
        </p>
